...
public class VecAccessibleOnVecAccessibles implements VecAccessible {
	...
	public VecWriteAccess getWriteAccess() {
		...
		if (m_writeAccess == null) {
			...
			m_writeAccess = new VecWriteAccess() {

				private VecWriteAccess m_curr = it.next().getWriteAccess();
	...
	public VecReadAccess createReadAccess() {
		final Iterator<VecAccessible> it = m_accessibles.iterator();
		return new VecReadAccess() {

			private VecReadAccess m_curr = it.next().createReadAccess();
