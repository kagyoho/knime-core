...
public final class TableFactory {
	...
	public static WritableTable createWritableTable(final ColumnSchema... schema) {
		// TODO get store from somewhere
		final Store store = new ArrowStore(schema);
		final DefaultWritableTable table = new DefaultWritableTable(store.getWritableColumns());
